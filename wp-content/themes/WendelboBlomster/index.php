...
<main>
    ...
    <section class="udvalgte">
        <div class="udvalgte-tekst">
            ...
            <a class="btn-gron" href="<?php echo site_url('/product-category/alle_produkter/jul/') ?>">Se julens blomster</a>
        </div>
        <div>
            <img src="<?php echo get_theme_file_uri('assets/img/juleblomster.png'); ?>" alt="billede af juleblomst" class="entryPoint-img">
        </div>
    </section>
