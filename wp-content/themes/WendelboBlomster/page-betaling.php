...
<a class="tilbage-link" href="<?php echo site_url('/bekraeft-bestilling') ?>">Tilbage til bekræft</a>
    ...
    <a class="tilBetaling-btn transition-link" href="<?php echo site_url('/tak-for-din-bestilling') ?>">Vælg og betal</a>
